...
#using class listview inplace of the product function above
...
#writing detailview class to replace the product details function above
...
class ProductUpdateView(UpdateView):
    ...
    #example : product_update_form.html to be created in the template dir
